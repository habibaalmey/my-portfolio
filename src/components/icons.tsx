...
export const Github = createIcon(
  <path d="M12 2C7 2 3 6 3 11c0 4 2.6 7.4 6.2 8.6-.1-.7-.2-1.8 0-2.5.2-.7 1.3-4.4 1.3-4.4s-.3-.6-.3-1.4c0-1.3.8-2.2 1.8-2.2.8 0 1.3.6 1.3 1.4 0 .8-.5 2-0.8 3.1-.2.9.4 1.6 1.3 1.6 1.5 0 2.7-1.6 2.7-4 0-2.1-1.5-3.6-3.7-3.6-2.5 0-4 1.9-4 3.8 0 .8.3 1.6.7 2.1.1.1.1.2.1.4-.1.4-.3 1.2-.4 1.3-.1.2-.3.2-.5.1-1.5-.7-2.4-2.7-2.4-4.3 0-3.5 2.5-6.6 6.9-6.6 3.6 0 6.4 2.6 6.4 6.1 0 3.6-2.3 6.5-5.4 6.5-1.1 0-2.1-.6-2.5-1.3l-.7 2.5c-.3 1-1 2.1-1.5 2.8.9.3 1.9.4 2.9.4 5 0 9-4 9-9s-4-9-9-9z" />,
  '0 0 24 24'
);
